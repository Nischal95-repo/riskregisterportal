...
import VisionLeaf from "../../static/images/vision-leaf.png";
    ...
    if (this.validator.allValid()) {
      ...
      this.props.client
        ...
        .then(result => {
          ...
          // redirectTo("/usersview");
          // this.props.history.push("/emp-test-list");
  ...
  render() {
    ...
    return (
      <div className="desktop" style={{ overflow: "hidden" }}>
        ...
        <div className="row">
          <div
            className="col-md-8 login-page"
            style={{ backgroundColor: "#69951a" }}
          >
            <div
            ...
            >
              ...
              >
                ...
                <div style={{ padding: "10px 30px" }}>
                  <h2 className="h2 text-center" style={{ color: "#9f9f9f" }}>
                    Login{" "}
                  </h2>
                  <div
                    className="row"
